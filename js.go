...
func (g *game) Save() error {
	...
	storage.Call("setItem", "runawaydsave", s)
	SaveError = ""
	return nil
}
...
func (g *game) SaveConfig() error {
	...
	storage.Call("setItem", "runawaydconfig", s)
	SaveError = ""
	return nil
}
...
func (g *game) SaveReplay() error {
	...
	storage.Call("setItem", "runawaydreplay", s)
	SaveError = ""
	return nil
}
...
func (g *game) RemoveSaveFile() error {
	storage := js.Global().Get("localStorage")
	storage.Call("removeItem", "runawaydsave")
	return nil
}
...
func (g *game) Load() (bool, error) {
	...
	save := storage.Call("getItem", "runawaydsave")
...
func (g *game) LoadConfig() (bool, error) {
	...
	conf := storage.Call("getItem", "runawaydconfig")
...
func (g *game) LoadReplay() error {
	...
	save := storage.Call("getItem", "runawaydreplay")
	if save.Type() != js.TypeString || runtime.GOARCH != "wasm" {
